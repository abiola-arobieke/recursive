...
# 📖 [Recursive] <a name="about-project"></a>

**Recursive** is a function that call itself. It works like a loop.
...
```sh
  git https://github.com/abiola-arobieke/recursive.git
```
...
- [ ] **Add a mocha test file for each file**
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/recursive/issues)
